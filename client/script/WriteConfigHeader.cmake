...
string (REPLACE "##CC_MQTT5_CLIENT_STRING_FIELD_FIXED_LEN##" "${CC_MQTT5_CLIENT_STRING_FIELD_FIXED_LEN}" text "${text}")
string (REPLACE "##CC_MQTT5_CLIENT_PROPERTIES_LIST_FIELD_FIXED_LEN##" "${CC_MQTT5_CLIENT_PROPERTIES_LIST_FIELD_FIXED_LEN}" text "${text}")
string (REPLACE "##CC_MQTT5_CLIENT_BIN_DATA_FIELD_FIXED_LEN##" "${CC_MQTT5_CLIENT_BIN_DATA_FIELD_FIXED_LEN}" text "${text}")
